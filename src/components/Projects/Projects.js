...
class Projects extends Component {
    state = {
        projects: [
            { name: 'SmartCart', image: <img className='project-image' src={smartCart} alt='project' />, viewUrl: ['video', smartCartVideo], gitHub: ['https://github.com/jmccueTechtonic/sc'], FELanguages: 'Sass | React', BELanguages: ' Node.js | Express | MySQL | Sequelize' },

            { name: 'Library City', image: <img className='project-image' src={libraryCity} alt='project' />, viewUrl: ['video', libraryCityVideo], gitHub: ['https://github.com/jmccueTechtonic/libCity'], FELanguages: 'Sass | React', BELanguages: ' Node.js | Express | MySQL | Sequelize' },
