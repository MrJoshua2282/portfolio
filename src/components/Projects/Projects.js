...
class Projects extends Component {
    state = {
        projects: [
            { name: 'ebuy', image: <img className='project-image' src={ebuy} alt='project' />, viewUrl: ebuyGif, gitHub: ['https://github.com/MrJoshua2282/ebuy-front-end', 'https://github.com/MrJoshua2282/ebuy-back-end'], languages: 'Css | React | Node.js | Express | MongoDb | Mongoose' },

            { name: 'Quiz', image: <img className='project-image' src={quiz} alt='project' />, viewUrl: 'https://mrjoshua2282.github.io/quiz/', gitHub: ['https://github.com/MrJoshua2282/quiz/tree/master'], languages: 'Sass | React' },
